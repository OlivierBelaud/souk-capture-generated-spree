...
The generator uses CSS classes for generated visual declarations. Some styles remain in `ditto.css` because they are route-scoped, pseudo-element based, keyframe based, interaction-state based, or too specific to translate safely without changing the rendered result.
...
- /de/de - Spree Commerce Demo | Next.js Ecommerce Storefront
- /de/de/products - Products | Spree Commerce Demo | Next.js Ecommerce Storefront
- /states/listing-default - Products | Spree Commerce Demo | Next.js Ecommerce Storefront
- /de/de/c/kitchen - Küche | Spree Commerce Demo | Next.js Ecommerce Storefront
- /de/de/products/digitale-heissluftfritteuse-6-2l - Digitale Heißluftfritteuse 6.2L | Spree Commerce Demo | Spree Commerce Demo | Next.js Ecommerce Storefront
- /states/product-structured - Digitale Heißluftfritteuse 6.2L | Spree Commerce Demo | Spree Commerce Demo | Next.js Ecommerce Storefront
- /states/product-cart-drawer-open - Digitale Heißluftfritteuse 6.2L | Spree Commerce Demo | Spree Commerce Demo | Next.js Ecommerce Storefront
- /de/de/cart - Spree Commerce Demo | Next.js Ecommerce Storefront
- /authentication/55145660472/login - Anmelden – Hydrogen Demo Store
- /states/account-dashboard - Anmelden – Hydrogen Demo Store
